...
That finishes our conversion to hardcoded module names. As we are not basing our module on the configuration anymore, we can remove all redundant configuration keys from the the main `config.exs` file:
...
We need to have a way to swap implementation between dev/test/integration and prod environments.
