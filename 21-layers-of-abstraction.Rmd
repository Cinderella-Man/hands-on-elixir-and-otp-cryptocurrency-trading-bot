...
We will stop here and **revert back** to the source code from the end of the [20th chapter]((https://github.com/Cinderella-Man/hands-on-elixir-and-otp-cryptocurrency-trading-bot-source-code/tree/chapter_20). Instead of leaving something that we are definitely not prepared to fix, we will look into alternatives based on the other dependency of the `Naive.Strategy`.

## Mimicking the reality

In this section, we will look into the dependency on the `Ecto.Repo` inside the `Naive.Strategy`.
