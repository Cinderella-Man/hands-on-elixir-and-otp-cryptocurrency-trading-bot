...
![Current state of affairs](images/chapter_04_01_current_state.png)
...
![Binance client dictated by config](images/chapter_04_02_proposal.png)
...
![BinanceMock needs to broadcast fake trade events back to the PubSub](images/chapter_04_03_proposal_pubsub.png)
...
![When to send fake trade events](images/chapter_04_04_explenation.png)
...
the implementation of `BinanceMock` for now. It's important to upcase the symbol as we want to be sure that we will match the topic name which is case-sensitive:
