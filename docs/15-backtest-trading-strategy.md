...
![Normal broadcast/subscribe flow](images/chapter_14_02_current_pubsub.png)
...
![Task feeds the stream of data from the database straight to the PubSub topic](images/chapter_14_03_backtest_pubsub.png)
