...
That finishes the shutdown functionality, as previously, one after another, positions will finish their cycles, and the whole process will exit at the end.