...
We can see that processes could get really complex really quick(supervision trees, too many messages etc).
Processes are a really powerful tool, and the responsibility lays on us developers to use them wisely - they **must not** be used for code organization.
